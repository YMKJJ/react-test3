...
function Accommodate(props){
    ...
    // 리액트 생명주기 함수를 사용하기 위해서 useEffect를 설정
    // 의존성 배열이 없는경우 componentDidMount, componentWillUnmount 를 실행한 것과 같은 효과
    useEffect(() => {
        console.log("=========");
        console.log("useEffect() is called");
        console.log(`isFull : ${isFull}`);
    },[]);
    // 의존성 배열에 count를 설정하여 count값이 수정되면 해당 componentDidUpdate를 실행하는 것과 같은 효과.
    useEffect(() => {
    ...
    return(
        <div>
            ...
            {/* 커스텀 훅을 통해서 만들어진 사용자 입장 퇴장 함수를 등록 */}
