...
// 부모 컨포넌트에서 자식 컴포넌트로 데이터를 전달 시, 사용
// 부모 컴포넌트에서 자식 컴포넌트를 호출하여 사용 시 속성을 사용하여 데이터를 전달.
// 부모 컨포넌트에서 사용한 속성명이 자식 컴포넌트의 props 객체에 담겨서 전달
    ...
    return(
        <div className={"row"}>
            <div className={"col-sm-6 mx-auto"}>
                ...
                <Profile userId={"test2"} userName={"테스터2"} userTel={"01012345678"} userEmail={"test2@bitc.co.kr"}/>
            </div>
        </div>
    );
}
